        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6 mb-4 mb-lg-0">
            ...
            <p className="hero-text">
              WizLearn transforms your study materials into personalized learning experiences...
            </p>
            ...
            <div className="hero-card">
              ...
              <div className="course-card">
                <div className="d-flex align-items-center mb-3">
                  ...
                  <div>
                    <h3 className="mb-1" style={{ color: '#1D2A50', fontWeight: 'bold', fontSize: '1.25rem' }}>
                      Data Structures
                    </h3>
                    <p className="mb-0" style={{ color: '#718096', fontSize: '0.875rem' }}>
                      42 lessons • 85% complete
                    </p>
                  </div>
                </div>
              ...
              <div className="row g-3">
                <div className="col-6">
                  <div style={{ backgroundColor: 'rgba(240,212,89,0.2)', borderRadius: '0.75rem', padding: '1.5rem', textAlign: 'center' }}>
