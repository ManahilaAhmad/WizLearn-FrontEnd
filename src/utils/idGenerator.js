...
export const getCourseColorByIndex = (index) => {
    const themeColors = [
        { from: '#1D2A50', to: '#2a3f6e' },     // Primary: Deep Blue (brand color)
        { from: '#F0D459', to: '#e8c850' },     // Secondary: Yellow/Gold (brand accent)
    ];

    // Alternate between the 2 colors (even = blue, odd = yellow)
